...
namespace Library
{
    ...
    public:
		...
		void swapCurrentMethod();
		void swapInitMethod();
		bool getCurrentMethod() const;
		bool getInitCurrMethod() const;
    ...
    protected:		
		...
		bool currentMethod{false}; //true for rasterizer false for raytracer simulation
		bool initCurrMethod{ false };
    };
}
