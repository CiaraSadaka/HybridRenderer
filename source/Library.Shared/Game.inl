...
namespace Library
{
	...
	inline void Game::swapCurrentMethod()
	{
		currentMethod = !currentMethod;
		initCurrMethod = true;
	
	}
	inline void Game::swapInitMethod()
	{
		initCurrMethod = !initCurrMethod;
	}
	inline bool Game::getCurrentMethod() const
	{
		return currentMethod;
	}
	inline bool Game::getInitCurrMethod() const
	{
		return initCurrMethod;
	}
}